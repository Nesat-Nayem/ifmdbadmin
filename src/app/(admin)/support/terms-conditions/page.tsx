...
import { useGetTermsConditionsQuery, useUpdateTermsConditionsMutation } from '@/store/termsConditionsApi'
...
const TermConditionsPage = () => {
  ...
  const { data: TermsConditions, isLoading, isError } = useGetTermsConditionsQuery()
