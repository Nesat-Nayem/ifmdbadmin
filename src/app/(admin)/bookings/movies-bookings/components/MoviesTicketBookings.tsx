              ...
              <table className="table align-middle mb-0 table-hover table-centered table-bordered">
                <thead className="bg-light-subtle">
                  <tr style={{ textWrap: 'nowrap' }}>
                    ...
                    <th style={{ textWrap: 'nowrap' }}>Movie Poster</th>
                    <th style={{ textWrap: 'nowrap' }}>Movie Name</th>
                    <th style={{ textWrap: 'nowrap' }}>User Name</th>
                    <th style={{ textWrap: 'nowrap' }}>Email</th>
                    <th style={{ textWrap: 'nowrap' }}>Phone</th>
                    <th style={{ textWrap: 'nowrap' }}>Hall Name</th>
...
export default MoviesTicketBookings
